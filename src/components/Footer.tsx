      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-white mb-4">منصة تعلم</h3>
            <p className="text-gray-400">
              منصة تعليمية عربية متكاملة تهدف إلى توفير تعليم عالي الجودة للجميع
            </p>
          ...
          {/* التصنيفات */}
          <div>
            <h3 className="text-xl font-bold text-white mb-4">التصنيفات</h3>
            <ul className="space-y-2">
              <li>
                <Link href="/courses?category=programming" className="hover:text-white transition-colors">
                  البرمجة
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/courses?category=languages" className="hover:text-white transition-colors">
                  اللغات
                </Link>
              </li>
              <li>
          ...
          {/* النشرة البريدية */}
          <div>
            <h3 className="text-xl font-bold text-white mb-4">النشرة البريدية</h3>
      ...
      <div className="border-t border-gray-800">
        <div className="container mx-auto px-4 py-6">
          <p className="text-center text-gray-400">
            جميع الحقوق محفوظة © {new Date().getFullYear()} منصة تعلم
          </p>
        </div>
      </div>
    </footer>
